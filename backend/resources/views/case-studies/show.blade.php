...
@section('title', $cs->title . ' | 森聡研究会')
@section('description', $cs->description ?? '慶應義塾大学 森聡研究会の公式サイト。国際政治学・現代アメリカ外交・先端技術を研究しています。')
...
<div>
    <div class="pt-32 pb-16 relative" style="background: linear-gradient(155deg, #041c33 0%, #0d5189 100%)">
        ...
        <div class="relative max-w-4xl mx-auto px-6 md:px-14">
            <a href="/case-studies" class="inline-flex items-center gap-2 text-white/40 hover:text-white text-xs tracking-widest uppercase mb-6 transition-colors">
    ...
    <div class="max-w-4xl mx-auto px-6 md:px-14 py-16">
        ...
        <div class="mt-12 pt-8 border-t border-gray-100">
            <a href="/case-studies" class="inline-flex items-center gap-2 text-primary-700 text-sm font-medium hover:gap-3 transition-all">
